...
import 'package:pelanggaran/Page/Guru/PrestasiSiswa/editprestasi.dart';

class DetailPrestasiSiswa2 extends StatefulWidget {
  const DetailPrestasiSiswa2({super.key});

  @override
  State<DetailPrestasiSiswa2> createState() => _DetailPrestasiSiswa2State();
}

class _DetailPrestasiSiswa2State extends State<DetailPrestasiSiswa2> {
