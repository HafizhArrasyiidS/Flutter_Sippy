...
import 'package:pelanggaran/Page/Guru/PelanggaranSiswa/detailpelanggaransiswa.dart';
import 'package:shared_preferences/shared_preferences.dart';

class EditPelanggaranSiswa2 extends StatefulWidget {
  const EditPelanggaranSiswa2({super.key});

  @override
  State<EditPelanggaranSiswa2> createState() => _EditPelanggaranSiswa2State();
}
...
class _EditPelanggaranSiswa2State extends State<EditPelanggaranSiswa2> {
...
void _showSuccessDialog() {
  ...
  Future.delayed(const Duration(seconds: 1), () {
    Get.to(DetailPelanggaranSiswa2());
  });
}
