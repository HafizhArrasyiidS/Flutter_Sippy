...
class InputPelanggaranSiswa2 extends StatefulWidget {
  const InputPelanggaranSiswa2({super.key});

  @override
  State<InputPelanggaranSiswa2> createState() => _InputPelanggaranSiswa2State();
}
...
class _InputPelanggaranSiswa2State extends State<InputPelanggaranSiswa2> {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: GestureDetector(
            onTap: () {
              Get.to(const PelanggaranSiswa2());
            },
            child: const Icon(
              Icons.arrow_back,
              color: Color(0xffffffff),
