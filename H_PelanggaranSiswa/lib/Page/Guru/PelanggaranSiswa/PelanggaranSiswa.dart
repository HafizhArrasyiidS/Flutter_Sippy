...
class PelanggaranSiswa2 extends StatefulWidget {
  const PelanggaranSiswa2({super.key});

  @override
  State<PelanggaranSiswa2> createState() => _PelanggaranSiswa2State();
}

class _PelanggaranSiswa2State extends State<PelanggaranSiswa2> {
  @override
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    Get.to(const DetailPelanggaranSiswa2());
                  },
                  child: Padding(
