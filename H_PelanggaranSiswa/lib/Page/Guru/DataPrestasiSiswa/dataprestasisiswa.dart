...
class DataPrestasi2 extends StatefulWidget {
  const DataPrestasi2({super.key});

  @override
  State<DataPrestasi2> createState() => _DataPrestasi2State();
}

class _DataPrestasi2State extends State<DataPrestasi2> {
  @override
            ...
            children: [
              ...
              ListView(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Get.to(const DetailDataPrestasiSiswa2());
                    },
                    child: Card(
