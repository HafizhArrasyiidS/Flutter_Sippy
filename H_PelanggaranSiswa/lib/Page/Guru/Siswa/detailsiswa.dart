...
class DetailSiswa2 extends StatefulWidget {
  const DetailSiswa2({super.key});

  @override
  State<DetailSiswa2> createState() => _DetailSiswa2State();
}

class _DetailSiswa2State extends State<DetailSiswa2> {
  @override
