...
class DataPelanggaranSiswa2 extends StatefulWidget {
  const DataPelanggaranSiswa2({super.key});

  @override
  State<DataPelanggaranSiswa2> createState() => _DataPelanggaranSiswa2State();
}

class _DataPelanggaranSiswa2State extends State<DataPelanggaranSiswa2> {
  @override
