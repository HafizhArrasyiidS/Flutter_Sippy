...
class DetailOrtu extends StatefulWidget {
  const DetailOrtu({super.key});

  @override
  State<DetailOrtu> createState() => _DetailOrtuState();
}

class _DetailOrtuState extends State<DetailOrtu> {
  @override
