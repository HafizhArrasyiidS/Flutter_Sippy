...
import 'package:pelanggaran/Page/Admin/Jurusan/addjurusan.dart';
import 'package:pelanggaran/Page/Admin/Jurusan/detailjurusan.dart';
import 'package:pelanggaran/Page/Admin/dashboardadmin.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;

class ListJurusan extends StatefulWidget {
  const ListJurusan({super.key});

  @override
  State<ListJurusan> createState() => _ListJurusanState();
}
...
class JurusanData {
  ...
  JurusanData({required this.id, required this.nama});
...
class _ListJurusanState extends State<ListJurusan> {
  ...
  List<JurusanData> searchData = [];
  Widget loadingListView = const Center(
    child: CircularProgressIndicator(),
  );

  void fetchDataJurusan(String query) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (decodeData is List) {
          List<JurusanData> newDataList =
              decodeData.map((item) => JurusanData.fromJson(item)).toList();
          if (mounted) {
            setState(() {
