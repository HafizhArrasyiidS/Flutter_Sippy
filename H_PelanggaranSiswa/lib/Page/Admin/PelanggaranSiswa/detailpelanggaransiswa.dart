...
import 'package:pelanggaran/Page/Admin/PelanggaranSiswa/editddatapelanggaran.dart';
...
class DetailPelanggaranSiswa extends StatefulWidget {
  const DetailPelanggaranSiswa({super.key});

  @override
  State<DetailPelanggaranSiswa> createState() => _DetailPelanggaranSiswaState();
}

class _DetailPelanggaranSiswaState extends State<DetailPelanggaranSiswa> {
