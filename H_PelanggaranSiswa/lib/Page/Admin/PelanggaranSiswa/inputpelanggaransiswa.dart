...
class InputPelanggaranSiswa extends StatefulWidget {
  const InputPelanggaranSiswa({super.key});

  @override
  State<InputPelanggaranSiswa> createState() => _InputPelanggaranSiswaState();
}
...
class _InputPelanggaranSiswaState extends State<InputPelanggaranSiswa> {
  late Timer _timer;
  ...
  @override
  void dispose() {
    // Cancel the timer to prevent calling setState() on disposed widget
    _timer.cancel();
    super.dispose();
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    items: <String>[
                      'Merokok', // daftar pilihan yang tersedia
                      'Mengejek Guru',
                      'Berkelahi',
                    ].map<DropdownMenuItem<String>>((String value) {
                      return DropdownMenuItem<String>(
  ...
  // Method untuk mengubah DateTime menjadi string format 'dd/MM/yyyy HH:mm'
