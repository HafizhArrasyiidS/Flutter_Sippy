...
class DetailJenisPrestasi extends StatefulWidget {
  const DetailJenisPrestasi({super.key});

  @override
  State<DetailJenisPrestasi> createState() => _DetailJenisPrestasiState();
}

class _DetailJenisPrestasiState extends State<DetailJenisPrestasi> {
  @override
