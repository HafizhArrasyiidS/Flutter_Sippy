...
class AddJenisPrestasi extends StatefulWidget {
  const AddJenisPrestasi({super.key});

  @override
  State<AddJenisPrestasi> createState() => _AddJenisPrestasiState();
}

class _AddJenisPrestasiState extends State<AddJenisPrestasi> {
  ...
  Future<void> jenisAdd() async {
    ...
    final response = await http.post(
      Uri.parse(
          'https://pelanggaranprestasi.000webhostapp.com/jenisprestasiapi/add'),
      body: {
    ...
    if (response.statusCode == 200) {
      ...
      Get.snackbar(
        'Sukses',
        "jenis prestasi ${jenisController.text} berhasil di tambah",
