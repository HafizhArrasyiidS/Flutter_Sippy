...
import 'package:pelanggaran/Page/Admin/JenisPelanggaran/addjenispelanggaran.dart';
import 'package:pelanggaran/Page/Admin/JenisPelanggaran/detailjenispelanggaran.dart';
  ...
  void fetchDataJenis(String query) async {
    ...
    try {
      final response = await http.get(
          Uri.parse(
              "https://pelanggaranprestasi.000webhostapp.com/jenispelanggaranapi"),
          headers: {
            'Cookie': token,
          });
