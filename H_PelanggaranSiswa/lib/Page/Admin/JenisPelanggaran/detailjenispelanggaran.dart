...
import '../Kelas/ListKelas.dart';

class DetailJenisPelanggaran extends StatefulWidget {
  const DetailJenisPelanggaran({super.key});

  @override
  State<DetailJenisPelanggaran> createState() => _DetailJenisPelanggaranState();
}

class _DetailJenisPelanggaranState extends State<DetailJenisPelanggaran> {
  @override
