...
class DataPelanggaranSiswa extends StatefulWidget {
  const DataPelanggaranSiswa({super.key});

  @override
  State<DataPelanggaranSiswa> createState() => _DataPelanggaranSiswaState();
}

class _DataPelanggaranSiswaState extends State<DataPelanggaranSiswa> {
  @override
